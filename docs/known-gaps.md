...
- Editor UX is consolidated under `src/features/editor`; RB-068 splits the previous monolithic client into smaller modules, RB-070 adds explicit eraser UX, RB-080/RB-081 harden full-resolution save readiness/payload behavior, RB-085 defines the crop-based scalable path, RB-086 adds BBox proposal mode, and RB-087 adds crop generation/preview. Advanced iPad zoom/pan gestures, tiled/downscaled working masks for memory-constrained devices, edit-session/multi-tab warnings, crop support editing, and deeper drawing/state hook decomposition remain deferred.
...
- RB-085/RB-086/RB-087 start the crop-based slice annotation sprint with the design contract, persistent BBox slice proposals, and derived crop generation. RB-088 through RB-092 remain the next crop-runtime slices.
