...
| Continue to slice annotation. | The unified crop annotation editor opens directly with Sapwood/Heartwood and Cu/Support family choices, support/semantic/classification/readiness status, and the whole-image slice navigator. |  |  |
