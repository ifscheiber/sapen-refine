...
- RB-086 adds rough BBox proposals for candidate slices, RB-087 adds derived crop generation, RB-088 adds crop support-mask editing, RB-089 adds crop semantic annotation, RB-090 adds auto classification suggestions with manual override provenance, RB-091 adds crop training export, and RB-092 adds shared crop readiness/review integration. Source-image-space crop-mask reprojection remains deferred.
