...
- RB-086 adds rough BBox proposals for candidate slices, RB-087 adds derived crop generation, RB-088 adds crop support-mask editing, RB-089 adds crop semantic annotation, and RB-090 adds auto classification suggestions with manual override provenance. Crop-aware exports and crop review integration remain deferred.
