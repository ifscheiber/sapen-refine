...
- The 2026-05-21 trial-hardening sequence is documented in `tickets/2026-05-21`: RB-070 covers editor eraser UX, RB-071 covers this docs/backlog consistency hotfix, RB-072 covers route-level API auth/error contracts, RB-073 covers trial deployment hygiene, RB-074 covers stale client API wrappers, RB-075 covers Prisma audit/version policy, and RB-076 through RB-078 cover deployment/iPad/post-trial gates.
