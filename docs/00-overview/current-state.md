...
- RB-086 adds rough BBox proposals for candidate slices, RB-087 adds derived crop generation, and RB-088 adds crop support-mask editing. Crop semantic annotation, auto classification, crop-aware exports, and crop review integration remain deferred.
