...
- `tests/e2e/slice-bbox-proposals.spec.ts` covers RB-086 editor BBox proposal creation, RB-094 crop workflow BBox-stage route/confirmation/continue behavior, RB-095/RB-096/RB-101/RB-123 slice navigation into the unified crop annotation editor, embedded right-rail navigator visibility, RB-103 BBox-stage re-entry from the crop editor, confirmed-set lock/unlock/re-confirm behavior, persistence through `/api/images/[imageId]/slice-bboxes`, RB-087/RB-101 crop generation/ensure behavior, crop preview visibility, and reload visibility.
