...
- `tests/unit/deployment-hygiene.test.ts` covers RB-073 Docker build-context exclusions, the Compose MinIO init command/script hygiene, and RB-081 Next proxy body-limit wiring.
