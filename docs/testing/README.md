...
- `tests/e2e/slice-bbox-proposals.spec.ts` covers RB-086 editor BBox proposal creation, RB-094 crop workflow BBox-stage route/confirmation/continue behavior, persistence through `/api/images/[imageId]/slice-bboxes`, RB-087 crop generation through `/api/slice-bboxes/[bboxVersionId]/crop`, crop preview visibility, and reload visibility.
