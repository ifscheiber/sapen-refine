...
- `tests/unit/slice-domain.test.ts` covers RB-051 support artifact kind helpers, latest classification resolution, RB-086 BBox validation errors, and RB-087 derived crop padding/geometry helpers.
...
- RB-086/RB-087 add crop-sprint runtime coverage for source-image BBox proposal validation, persistence, derived crop generation, clipped padding, private crop reads, and editor reload. Crop support-mask dimensions, crop-aware exports, and crop review eligibility remain deferred to RB-088 through RB-092.
