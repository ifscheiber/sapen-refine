...
- `tests/e2e/crop-workflow-closeout.spec.ts` covers the RB-098/RB-123 crop workflow closeout gaps: Copper semantic drafts can be saved before explicit support but remain non-ready until support/semantic/classification review is complete, and active Sapwood/Heartwood annotation disables the Cu/Support family.
