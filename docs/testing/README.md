...
- `tests/e2e/annotator-surface.spec.ts` covers the RB-121 Annotator/`LABELER` browser surface: no project creation/settings/exports/tasks/prediction-import navigation, hidden operational status counts, image upload entry, metadata link visibility, and crop workflow entry.
