...
- RB-086/RB-087/RB-088/RB-089 add crop-sprint runtime coverage for source-image BBox proposal validation, persistence, derived crop generation, clipped padding, private crop reads, crop support-mask lineage/dimensions, support-constrained crop semantic masks, and editor reload. Crop-aware exports and crop review eligibility remain deferred to RB-091/RB-092.
