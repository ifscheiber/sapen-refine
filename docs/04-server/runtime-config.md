...
- `SAPEN_OPERATOR_EMAIL`, optionally `SAPEN_REQUIRE_OPERATOR_ATTRIBUTION=true` - named operator attribution for trial bootstrap and trial-user creation. Do not put passwords, tokens, or file-secret paths in this value.
