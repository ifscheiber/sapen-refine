...
- Task queue links to the existing editor route with task/provenance query parameters; consuming those parameters is deferred to the assisted-correction editor slice.
