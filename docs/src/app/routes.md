...
- `/app/projects/[projectId]` - active-project image workspace from `src/app/(workspace)/app/projects/[projectId]/page.tsx` and `src/features/projects/ProjectsWorkspacePage.tsx`, including project context, image list/upload controls, status rail, and project operations links. `?tab=settings` opens the project metadata settings tab.
...
- `/app/projects/[projectId]/images` - dedicated project image list/upload page from `src/app/(workspace)/app/projects/[projectId]/images/page.tsx` and `src/features/images/ProjectImagesPage.tsx`; `/app/projects/[projectId]` is the primary workspace entry.
