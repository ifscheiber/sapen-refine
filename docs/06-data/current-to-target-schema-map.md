...
| `ProjectRole` | Replaced after development DB reset. | `AnnotationProjectRole` with `OWNER`, `QA`, `LABELER`, `VIEWER`. Role semantics are documented for annotate/review/export but advanced authorization remains RB-052/RB-053 work. |
