...
- Training export exists as an RB-053/RB-091 project-level workflow with RB-112 async package generation; advanced export filters/history remain deferred.
- Prediction-assisted correction is designed by RB-054 and now has RB-056 provenance storage, RB-057 prediction mask import, RB-058 correction queues, RB-059 assisted editor correction, RB-060/RB-112 async prediction-analysis export, RB-061 batch prediction imports, RB-065 single-host batch runner hardening, RB-066 temporary storage cleanup, and RB-067 export-time QA metrics. Running inference, metrics dashboards, cleanup UI, and production-scale workers remain deferred.
