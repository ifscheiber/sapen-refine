...
- `src/server/domain/predictionAnalysisExports.ts` - prediction-analysis export readiness, async manifest/package generation, and owner/QA download authorization.
