...
4. `done/RB-129-refine-bbox-direct-draw-edit-per-bbox-annotation-locks.md`
   - Direct Select/Edit/Draw BBox canvas interaction.
   - Per-BBox downstream annotation locks.
   - Explicit downstream invalidation confirmation.
   - No global edit unlock or persistent regenerate action.
