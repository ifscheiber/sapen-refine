...
- Crop semantic masks: `/app/projects/[projectId]/images/[imageId]/slices/[sliceInstanceId]/crops/[cropId]/semantic` edits crop-sized semantic masks through `/api/slice-crops/[cropId]/semantic-mask`; saved versions use `CROP_PIXEL`, require the current crop support mask, link to the exact support mask version, and reject semantic foreground outside support.
